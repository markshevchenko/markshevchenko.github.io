...
> #### Машина Тьюринга
> Машина состоит из нескольких лент, разбитых на клетки. Каждой клетка либо пуста, либо содержит один символ. У каждой ленты есть своя *каретка*, которая может
...
не позволяет распознавать такое множество строк. Но стоит добавить к ней второй стек, как она становится эквивалентна машине Тьюринга и λ-исчислению.
...
Рубеж 70&ndash;80 годов оказался роковым для программистов. Компьютеры дешевели, росли объёмы оперативной памяти и быстродействие. В этих условиях активно развивались «ресурсоёмкие» языки — Смолток,
LISP, ML. Но появление персоналок вернуло индустрию на 10 лет назад, в ситуацию, где битва шла за каждый килобайт.
