...
Учёным удалось формально описать элементарную логику, логику предикатов, арифметику и теорию множеств. Каждую из этих теорий можно представить, как расширение предыдущей, например, исчисление предикатов это исчисление высказываний с предикатами и кванторами, а арифметика, в свою очередь, расширяет исчисление предикатов.
...
Это положение доказал Курт Гёдель. Его первая теорема о неполноте гласит, что любая формальная теория, не менее сложная, чем арифметика, либо полна, либо непротиворечива. Вторая теорема утверждает, что средствами арифметики нельзя доказать её собственную
непротиворечивость.
...
Однако, непротиворечивость этой теории также требовала обоснования. В полном соответствии с теоремами Гёделя, надеждам на обоснование математики формальными методами сбыться было не суждено.

Но, если математики проиграли сражение за полноту и непротиворечивость, может быть они могли выиграть на поле разрешимости?

## Пооблема разрешения

Как мы помним, в исчеслении высказываний существует *разрешаюшая процедура* для определения истинности теорем: чтобы узнать, верна ли теорема, мы строим таблицу истинности и изучаем столбец результата. Жизнь математиков сильно упростилась бы, умей они определять
истинность теорем в других системах.
...
> к `m` и получить в результате `mm`, никак не поясняя это означает это дублирование&nbsp;&mdash; мы просто подставили `m` вместо `x`.
>
> Что можно сделать с помощью такой несложной абстракции? Чёрчу удалось представить в виде λ-функций логику и арифметику
> натуральных чисел вместе с операциями конъюнкции, дизъюнкции, сложения и умножения. И, поскольку, например, сложение выразимо
> виде λ-выражения, оно *вычислимо*.

Вычислима ли разрешающая процедура для логики предикатов? В своей работе Чёрч доказал, что нет, и, следовательно, *проблема разрешения*
...
Алан Тьюринг доказал неразрешимость Entscheidungsproblem через несколько месяцев после Чёрча, использовав совершенно другую абстракцию.
Узнав о работе Чёрча, он решил 
