...
Как мы помним, в исчеслении высказываний существует *разрешаюшая процедура* для определения истинности теорем: чтобы узнать, верна ли теорема, мы строим таблицу истинности и изучаем столбец результата. Жизнь математиков сильно упростилась бы, умей они подобным образом определять истинность теорем из логики предикатов, арифметики и теории множеств.

Уже известный нам Давид Гильберт сформулировал *проблему разрешения*&nbsp;&mdash; найти *разрешающую процедуру* для систем сложнее исчисления высказываний.

*Проблема разрешения* (*нем.* Entscheidungsproblem, *произносится* ɛntˈʃʌɪdʊŋsˌpɹɒbləm) важна для нас, программистов, тем, что вводит понятие *процедуры* или *алгоритма*. Именно при решении этой проблемы математики дали определение понятию *вычислимости*.

Американский математик Алонзо Чёрч, создатель лямбда-исчисления назвал эффективно вычислимыми все λ-определимые функции.

Нет. Не существует способ определения истинности теорем в арифметике и более сложных системах.
