...
## Пооблема разрешения (Entscheidungsproblem)

Как мы помним, в исчеслении высказываний существует *разрешаюшая процедура* для определения истинности теорем; надо построить таблицу истинности и посмотреть в столбец результата. Жизнь математиков сильно упростилась бы, умей они подобным способом определять истинность теорем из логики предикатов, арифметики и теории множеств.
...
*Проблема разрешения*, по немецки Entscheidungsproblem (произностися ɛntˈʃʌɪdʊŋsˌpɹɒbləm) очень важна для программистов, поскольку в ней речь идёт о нахождении *процедуры*, а, фактически, *алгоритма*.
меМатистинность теорем в системах, которые сложнее исчисления высказываний.

Американский математик Алонзо Чёрч, обнаружил, что такого способа нет.
