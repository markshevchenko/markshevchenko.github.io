...
Программа вычисления первых чисел Фибоначчи на Фортране. Здесь современная версия языка, потому что на классическую программу современные компиляторы ругаются.
...
Первые функциональные языки появились практически сразу после Фортрана. LISP, дедушка современного функционального программирования, был разработан в 1958-м году. В его
основу положено λ-исчисление.
...
(print (map 'list 'fibonacci (numbers 20)))
```
...
Структурное программирование довольно долго оставалось главной парадигмой индустрии&nbsp;&mdash; практически 20 лет (70&ndash;90гг.), и это не смотря на то, первым объектно-ориентированным языком
принято считать Симулу, созданную в 1967г.
...
языки&nbsp;&mdash; Смолток, LISP, ML. Но появление персоналок вернуло индустрию на 10 лет назад, в ситуацию, где битва шла за каждый килобайт.
...
переопределения методов через таблицу виртуальных функций. Способ оказался настолько хорош, что используется сейчас не только в Си++, но и в подавляющем большинстве современных
