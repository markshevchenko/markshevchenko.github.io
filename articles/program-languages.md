...
Тьюринг доказал, что невозможно написать программу, которая могла бы определять истинность утверждений арифметики. Так как его работа появилась позже работы Чёрча, Тьюринг
сравнил два
