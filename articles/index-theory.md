...
Для начала давайте разберёмся, что такое быстрый поиск, и как он работает. Предположим, у нас есть телефонный справочник, где записаны все жители города с адресами и телефонами. Чтобы сделать этот справочник, мы разолали по городу переписчиков с анкетами и составили один большой список. Если мы специально не будем упорядочивать этот список, жители в нём будут находиться почти в случайном порядке.

Предположим, мы хотим найти адрес Александра Сергеевича Пушкина. Нам придётся читать все записи подряд, пока мы не встретим нужное нам имя. Если справочник содержит *N* жителей, то в худшем случае нам придётся прочитать *N* записей.
...
Давайте предположим, что мы хотим найти телефон человека, зная его адрес. У нас есть телефонный справочник, где записи упорядочены по фамилии. Сколько времени нам потребуется, чтобы завершить поиск? Оказывается, что в худшем случае речь снова идёт о *N* попытках. То, что справочник упорядочен по фамилии, никак не помогает искать человека по адресу.

Чтобы решить такую задачу, нам нужен второй справочник, с другим способом сортировки.

Конечно, справочники с разной сортировкой встречаются нечасто. Чтобы двигаться дальше, нам потребуется новая метафора, которая поможет разобраться с несколькими способами упорядоивания.

Предположим, читатель ищет книгу по фамилии автора. Если книги расположены по фамилиям, сделать это нетрудно. Сначала мы помечаем полки первыми буквами фамилий: А, Б, В; затем расставляем книги. Но что делать, если читатель ищет книгу по названию?
