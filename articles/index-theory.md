...
Поскольку шкафы могут находиться в разных метах библиотеке, такой поиск может сильно затянуться.


#### Сервер

Сервер в данном случае работает точно также, как библиотекарь.
