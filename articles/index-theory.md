...
Некоторые школьники отмечают, что IP-адрес можно хранить не в виде строки, а запаковывать его в 4 байта. Я назову это решение спорным. Оно усложняет
код и затрудняет ручую работу с базой. Теоретически, так вы сможете сэкономить несколько мегабайт дискового пространства, и ускорить выполнение запросов.
На практике, стоимость этой экономии составит несколько центов в год, а увеличение скорости не удастся подтвердить достоверно.

Наконец, код в обучающей статье должен быть простым. Поэтому я обойдусь без микрооптимизаций.
