...
|     N     | &rceil;log₂ N&lceil; |  &rfloor;N/log₂ N&lfloor; |
|       1000|                    10|                      100|
|      10000|                    14|                      714|
...
Скобки &rceil; и &lceil; означают округление вверх, а &rfloor; и &lfloor;&nbsp;&mdash; вниз.

Третья колонка показывает, насколько двоичный поиск быстрее перебора. Для тысячи записей в сто раз,, для миллиона чисел&nbsp;&mdash; в пятьдесят тысяч раз, а для миллиарда&nbsp;&mdash; в тридцать миллионов раз!
...
Если мы захотим найти все журналы за 2004 и 2005 годы, нам не придётся создавать новую картотеку с ключом &laquo;год&raquo;., поскольку индекс по году у нас уже присутствует&nbsp;&mdash; мы можем просто не учитывать месяц.
