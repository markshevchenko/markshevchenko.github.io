...
feed:
  path: feed.atom
```
Наконец, нам потребуется подставить ссылку ATOM в заголовок наших страниц. Добавим мета-тег `{% feed_meta %}` в заголовок основного HTML-шаблона **default.html**:
{% raw %}
```liquid
<!doctype html>
<html lang="{{ page.lang | default: site.lang }}">
...
После компиляции сайта в коде страницы мы увилим ссылку на документ ATOM:
