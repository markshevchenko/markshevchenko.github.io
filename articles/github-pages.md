...
Например создадим в репозитории файл **_includes/header**:
...
## Оформление сайта&nbsp;&mdash; Sass

[Sass](https://sass-lang.com/)&nbsp&mdash; аналог шаблонов для CSS. Он позволяет упростить описание стилей и исключить дублирование. Для его корректной работы
...
Обратите внимание, что в начале файла должны находиться две строки, содержащие каждая по три дефиса. Далее мы разбиваем наше описание на четыре части. В **main.scss** мы задаём
