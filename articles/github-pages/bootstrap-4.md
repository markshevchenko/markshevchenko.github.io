...
что там будет. Мы стали формулировать *тему* встречи, и люди начали приходить. Посиделки перестали быть *неформальными*, но
...
Такая картина оказывается нужна и другим программистам, и смежным специалистам. У нас бывают и доклады, и тогда результатом встречи становится
...
![Макет для мобильных устройств](bootstrap-4-smartphone.png)
...
Справа от изображения разместим текст **Москвоский клуб программистов**. Это заголовок, но к размерам этого текста мы вернёмся позже.
...
![Результат для мобильных устройств](bootstrap-4-smartphone-result.png)
...
![Макет для мониторов](bootstrap-4-desktop.png)
...
![Результат для мониторов](bootstrap-4-desktop-result.png)
