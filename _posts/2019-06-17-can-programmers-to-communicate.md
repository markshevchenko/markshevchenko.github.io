...
Предположим, что общительность по тесту измеряется до 0 до 15. Это означает, что сигма равна чуть менее 2,5 пунктов, и середина приходится на 7,5. Если вы получили 6 пунктов по шкале общительности, то ваш показатель где-то на расстоянии 0,6 сигм от центра ($0,6 = \frac{7,5-6}{2,5}$).
