...
excerpt: Как протестировать, что метод корректно вызывает DateTime.Now, ведь мы не знаем, какое значение будет установлено? Предлагаю простое решение для C#.
---
