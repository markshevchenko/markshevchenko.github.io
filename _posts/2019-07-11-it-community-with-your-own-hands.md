...
Вместимость зала тридцать человек. Я открываю регистрацию, и через два дня количество участников приближается к пятидесяти. “Где они сидеть-то будут?”,&nbsp;&mdash; думаю я обречённо и закрываю регистрацию.
